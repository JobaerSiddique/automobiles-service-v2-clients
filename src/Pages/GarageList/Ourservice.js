...
const Ourservice = ({services}) => {
    return (
        <div className='mt-40'>
            <h1 className='font-bold text-xl lg:text-5xl text-center text-white'>Our Services</h1>
            <div className='grid justify-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 mt-10  p-5'>
