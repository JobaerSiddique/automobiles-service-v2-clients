...
const ExperienceInfo = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse ">
    ...
    <div  className='mt-5 p-5'>
      ...
      <div className='mt-5'>
      <p className='flex'  ><IoIosCheckmarkCircleOutline className='mt-1 text-orange-600 font-bold'/><span className='ml-5 text-base font-semibold'>Our toll-free call centers are available</span></p>
